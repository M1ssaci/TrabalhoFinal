...
public class Produto{
    ...
    public Produto(Long idProduto, Long idFornecedor, List<FormaEntrega> formaEntregas, FichaTecnica fichaTecnica, String nome, double preco,
    ...
    public Produto(Long idFornecedor, String nome, double preco, double precoVenda, String[] urls, List<FormaEntrega> formas, FichaTecnica ficha, Categoria categoria, Moeda moeda, Oferta oferta) {
        this.idFornecedor = idFornecedor;
        this.nome = nome;
        this.preco = preco;
        this.precoVenda = precoVenda;
